...
const Input:React.FC<InputProps> = ({ id, label, type="text", disabled, formatPrice, formatPercentage, required, register, errors }) => {
    return (
        <div className="w-full relative">
            ...
            <label className={`absolute text-md duration-150 transform -translate-y-3 top-5 z-1 origin-[0] 
