...
const ReviewModal: React.FC<ReviewsComponentProps> = ({isModalOpen,setIsModalOpen,reviews,formatPostedTime}) => {
  ...
  return (
      <div>
        <Modal isOpen={isModalOpen} onClose={()=>{setIsModalOpen(false)}} customWidth='sm:max-w-4xl'>
        <div className="p-8">
      {/* Display Average Rating */}
      <div className="mb-8">
        <h2 className="text-2xl font-semibold">Average Rating: {averageRating.toFixed(1)}</h2>
